...
export class OSWAP_RestrictedPair2 extends Contract{
    ...
    async getAmountIn(params:{tokenOut:string,amountOut:number|BigNumber,trader:string,param4:string}): Promise<BigNumber>{
        let result = await this.methods('getAmountIn',params.tokenOut,this.utils.toString(params.amountOut),params.trader,params.param4);
        return new BigNumber(result);
    }
