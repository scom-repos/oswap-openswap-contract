...
const OSWAP_RestrictedPairCreator4_json_1 = __importDefault(require("./OSWAP_RestrictedPairCreator4.json"));
class OSWAP_RestrictedPairCreator4 extends eth_contract_1.Contract {
