...
const OSWAP_OtcPair_json_1 = __importDefault(require("./OSWAP_OtcPair.json"));
class OSWAP_OtcPair extends eth_contract_1.Contract {
    ...
    decodeAddLiquidityEvent(event) {
        ...
        return {
            ...
            originalAmount: new eth_contract_1.BigNumber(result.originalAmount),
    ...
    decodeSwappedOneOfferEvent(event) {
        ...
        return {
            ...
            newAmountBalance: new eth_contract_1.BigNumber(result.newAmountBalance),
            newReceivingBalance: new eth_contract_1.BigNumber(result.newReceivingBalance),
            swappedAmountBalance: new eth_contract_1.BigNumber(result.swappedAmountBalance),
            _event: event
        };
    }
    assign() {
        ...
        let offers_call = async (params, options) => {
            ...
            return {
                ...
                originalAmount: new eth_contract_1.BigNumber(result.originalAmount),
                amount: new eth_contract_1.BigNumber(result.amount),
                swappedAmount: new eth_contract_1.BigNumber(result.swappedAmount),
