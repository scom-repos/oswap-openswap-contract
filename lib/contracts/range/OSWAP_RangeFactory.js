...
class OSWAP_RangeFactory extends eth_contract_1.Contract {
    ...
    assign() {
        ...
        let getAllLiquidityProviderShare_call = async (options) => {
            ...
            return {
                stakeAmount: result._stakeAmount.map(e => new eth_contract_1.BigNumber(e)),
                liquidityProviderShare: result._liquidityProviderShare.map(e => new eth_contract_1.BigNumber(e))
            };
        };
